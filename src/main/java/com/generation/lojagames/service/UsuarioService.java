...
public class UsuarioService {
	...
	public Optional<Usuario> cadastrarUsuario(Usuario usuario) {
	    ...
	    if (!isMaiorDeIdade(usuario.getDataNasc())) {
	        throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Usuário deve ter 18 anos ou mais");
	    }
	...
	private boolean isMaiorDeIdade(LocalDate dataNasc) {
